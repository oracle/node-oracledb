...
describe('14. stream2.js', function() {
  ...
  it.skip('14.10 Negative - set streamNumRows to be 0', function(done) {
    var sql = 'SELECT employees_name FROM nodb_employees WHERE employees_id = :1';
    var stream = connection.queryStream(sql, [40], {streamNumRows: 0});
  ...
  it.skip('14.11 Negative - set streamNumRows to be NaN', function(done) {
    var sql = 'SELECT employees_name FROM nodb_employees WHERE employees_id = :1';
    var stream = connection.queryStream(sql, [40], {streamNumRows: NaN});
  ...
  it('14.12 Negative - set streamNumRows to be a negative number', function(done) {
    var sql = 'SELECT employees_name FROM nodb_employees WHERE employees_id = :1';
    var stream = connection.queryStream(sql, [40], {streamNumRows: -9});

    stream.on('error', function(error) {
      should.exist(error);
      (error.message).should.startWith('NJS-006');
      // NJS-006: invalid type for parameter 1
      setTimeout(done, 500);
    });
  ...
  it('14.13 Negative - set streamNumRows to be a string', function(done) {
    var sql = 'SELECT employees_name FROM nodb_employees WHERE employees_id = :1';
    var stream = connection.queryStream(sql, [40], {streamNumRows: 'foobar'});
