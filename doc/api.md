...
This property was added in node-oracledb 3.0.  Note in node-oracledb 3
this property is incorrectly a String.  This will change to the
documented Object type in node-oracledb 4.0.
