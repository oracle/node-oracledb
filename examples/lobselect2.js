 ...
 *
 * DESCRIPTION
 *   SELECTs a CLOB and displays output to the console (with row locking).
 *   SELECTs a BLOB and writes it to a file.
 *   Trims the CLOB and displays the trimmed LOB to the console.
 *
  ...
  try {
    ...
    */
    ...
    result = await connection.execute(
      `SELECT c FROM no_lobs WHERE id = :idbv for update`,
      [1],
