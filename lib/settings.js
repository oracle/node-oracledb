    ...
    for (const element of fetchAsString) {
      switch (element) {
        ...
        case constants.DB_TYPE_NCLOB:
          map.set(constants.DB_TYPE_CLOB, constants.DB_TYPE_LONG);
          map.set(constants.DB_TYPE_NCLOB, constants.DB_TYPE_LONG_NVARCHAR);
          break;
    ...
    for (const element of fetchAsBuffer) {
      switch (element) {
        case constants.DB_TYPE_BLOB:
          map.set(constants.DB_TYPE_BLOB, constants.DB_TYPE_LONG_RAW);
          break;
        default:
          errors.throwErr(errors.ERR_INVALID_TYPE_FOR_CONVERSION);
      }
