...
class ResultSet {
  ...
  //---------------------------------------------------------------------------
  async close() {
    await this._close.apply(this, arguments);
  }
  ...
  //---------------------------------------------------------------------------
  async getRow() {
    return await this._getRow.apply(this, arguments);
  }

  async _doGetRows(numRows) {
    let rowsNeeded;
  ...
  //---------------------------------------------------------------------------
  async getRows() {
    return await this._doGetRows.apply(this, arguments);
  }
