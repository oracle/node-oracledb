...
class Pool extends EventEmitter {
  ...
  _setup(poolAttrs, poolAlias) {
    ...
    // and can be overridden at pool creation time.
    ...
    if (typeof poolAttrs.externalAuth !== 'undefined') {
      ...
      this.externalAuth = settings.externalAuth;
    }
    ...
    Object.defineProperties(
      this,
      {
        ...
        _status: {  // open/closing/closed
          value: constants.POOL_STATUS_OPEN,
          writable: true
        },
        poolAlias: {
          enumerable: true,
