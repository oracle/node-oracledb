...
class DbType {
  ...
  constructor(num, name, columnTypeName, options) {
    ...
    this.defaultSize = options.defaultSize || 0;
...
function getTypeByOraTypeNum(oraTypeNum, csfrm) {
  ...
  if (!dbType)
    errors.throwErr(errors.ERR_INVALID_ORACLE_TYPE_NUM, oraTypeNum);
  return dbType;
}
...
const DB_TYPE_CHAR = new DbType(2003,
  "DB_TYPE_CHAR", "CHAR",
  { oraTypeNum: 96, defaultSize: 2000, csfrm: constants.CSFRM_IMPLICIT,
    bufferSizeFactor: 4 });
...
const DB_TYPE_NCHAR = new DbType(2004,
  "DB_TYPE_NCHAR", "NCHAR",
  { oraTypeNum: 96, defaultSize: 2000, csfrm: constants.CSFRM_NCHAR,
    bufferSizeFactor: 4 });
...
const DB_TYPE_NVARCHAR = new DbType(2002,
  ...
  { oraTypeNum: 1, defaultSize: 4000, csfrm: constants.CSFRM_NCHAR,
    bufferSizeFactor: 4 });
...
const DB_TYPE_RAW = new DbType(2006,
  "DB_TYPE_RAW", "RAW",
  { oraTypeNum: 23, defaultSize: 4000, bufferSizeFactor: 1 });
...
const DB_TYPE_VARCHAR = new DbType(2001,
  ...
  { oraTypeNum: 1, defaultSize: 4000, csfrm: constants.CSFRM_IMPLICIT,
    bufferSizeFactor: 4 });
