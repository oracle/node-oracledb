...
// This expression captures the prologue of the exception also with --enable-source-maps
const stacktraceRe = /^[\s\S]*Error: #/;
...
function callbackify(func) {
  return function() {
    ...
    // to keep stacktrace before async operation 
