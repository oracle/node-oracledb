...
class ConnectionImpl {
  ...
  _getConnectTraceConfig() {
    ...
    traceConfig.pdbName = this.getPdbName();
    traceConfig.dbName = this.getDbName();
    traceConfig.domainName = this.getDbDomain();
    ...
    if (settings.thin) {
      ...
      traceConfig.dbUniqueName = this.getDbUniqueName();
    }
    return traceConfig;
  }
  ...
  //---------------------------------------------------------------------------
  getPdbName() {
    errors.throwNotImplemented("getting pdb name");
  }
  ...
  //---------------------------------------------------------------------------
  getDbUniqueName() {
    errors.throwNotImplemented("getting db unique name");
  }
  ...
  //
  // Sets the End Security Context.
  //---------------------------------------------------------------------------
  setEndUserSecurityContext() {
    errors.throwNotImplemented("setting End User Security Context");
  }

  //---------------------------------------------------------------------------
  // clearEndUserSecurityContext()
  //
  // Clears the End Security Context.
  //---------------------------------------------------------------------------
  clearEndUserSecurityContext() {
    errors.throwNotImplemented("clearing End User Security Context");
  }
  ...
  // supportsPipelining()
  //
  // Returns true if pipelining is supported.
  //---------------------------------------------------------------------------
  supportsPipelining() {
    return false;
  }
  ...
  //---------------------------------------------------------------------------
  directPathLoad() {
    errors.throwNotImplemented("direct path load");
  }
  ...
  //---------------------------------------------------------------------------
  appContext() {
    errors.throwNotImplemented("setting app context");
  }
  ...
  //---------------------------------------------------------------------------
  clearAppContext() {
    errors.throwNotImplemented("clear app context");
  }
