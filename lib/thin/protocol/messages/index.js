...
const DirectPathPrepareMessage = require('./directPathPrepare.js');
const DirectPathLoadStreamMessage = require('./directPathLoadStream.js');
const DirectPathOpMessage = require('./directPathOp.js');
const ExecuteMessage = require('./execute.js');
const EndPipelineMessage = require('./endPipeline.js');
...
module.exports = {
  ...
  FastAuthMessage,
  DataTypeMessage,
  DirectPathPrepareMessage,
  DirectPathLoadStreamMessage,
  DirectPathOpMessage,
  ExecuteMessage,
  EndPipelineMessage,
  FetchMessage,
