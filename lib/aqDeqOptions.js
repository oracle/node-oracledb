...
class AqDeqOptions {
  ...
  set consumerName(value) {
    errors.assertPropLength(value, "string", 128, "consumerName");
  ...
  set correlation(value) {
    errors.assertPropLength(value, "string", 128, "correlation");
  ...
  set transformation(value) {
    errors.assertPropLength(value, "string", 128, "transformation");
