...
class SodaCollection {
  ...
  async createIndex(spec) {
    ...
    return await this._impl.createIndex(JSON.stringify(spec));
  }
  ...
  async insertMany(docs) {
    ...
    await this._impl.insertMany(actualDocs);
  }
  ...
  async insertOne(content) {
    ...
    await this._impl.insertOne(content);
  }
